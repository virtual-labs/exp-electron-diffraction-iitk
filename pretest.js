  ...
  const myQuestions = [
    {
      ...
      answers: {
        ...
        c: "Henry",                  ///// Write the option 2 inside double quotes
        d: "Eular",                  ///// Write the option 2 inside double quotes
...

    {
      question: "2. The selection rule of planes for a simple cubic (SC) crystal is ",  ///// Write the question inside double quotes
       answers: {
         ...
         c: "(h+k+l) is odd",                  ///// Write the option 2 inside double quotes
         d: "(h, k, l) are all odd or all even (unmixed) ",                  ///// Write the option 2 inside double quotes
